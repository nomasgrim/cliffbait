  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex items-center gap-3">
        ...
        <li 
          className="w-8 h-8 rounded-full ring-1 ring-gray-300 cursor-pointer relative bg-blue-500"
        >
        </li>
        <li 
          className="w-8 h-8 rounded-full ring-1 ring-gray-300 cursor-not-allowed relative bg-green-500"
        >
          <div 
            className="absolute 
              w-10 h-[2px] 
      ...
      <ul className="flex itemx-center gap-3">
